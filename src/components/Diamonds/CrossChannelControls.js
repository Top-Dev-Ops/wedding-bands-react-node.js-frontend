...
class CrossChannelControls extends Component {
    ...
    render() {
        ...
        if (diamond_cut == 0) {
            num_of_stones = [...Array.from({ length: 4 }, (_, i) => i + 1)];
            _num_of_stones = [...Array.from({ length: 4 }, (_, i) => i + 1)];
...
CrossChannelControls.propTypes = { data: PropTypes.object.isRequired };
...
export default connect(mapStateToProps, mapActionsToProps)(CrossChannelControls);