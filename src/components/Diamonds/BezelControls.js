...
class BezelControls extends Component {
                ...
                <div className="row justify-content-start">
                    ...
                    <div className="col-sm-4 diamond-cuts cut-class">
                        ...
                        <ul>
                            ...
                            <li id="diamond_cut_1" className={diamond_cut == 1 ? 'option active' : 'option'} onClick={this.handleDiamondCut}><span id="diamond_cut_1" style={{ backgroundImage: `url(${princess})` }}></span></li>
                            <li id="diamond_cut_2" className={diamond_cut == 2 ? 'option active' : 'option'} onClick={this.handleDiamondCut}><span id="diamond_cut_2" style={{ backgroundImage: `url(${baguette})` }}></span></li>
                        </ul>
                    </div>
...
BezelControls.propTypes = { data: PropTypes.object.isRequired };
...
export default connect(mapStateToProps, mapActionsToProps)(BezelControls);