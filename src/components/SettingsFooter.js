...
class SettingsFooter extends Component {
    ...
    checkIfReduxDataStateChanged(prevProps, nowProps) {
        if (prevProps.ring_1_disabled != nowProps.ring_1_disabled) { return true; }
        ...
        else if (prevProps.ring_1_fineness != nowProps.ring_1_fineness) { return true; }
        ...
        else if (prevProps.ring_1_2_metal != nowProps.ring_1_2_metal) { return true; }
        else if (prevProps.ring_1_2_fineness != nowProps.ring_1_2_fineness) { return true; }
        ...
        else if (prevProps.ring_1_3_fineness != nowProps.ring_1_3_fineness) { return true; }
